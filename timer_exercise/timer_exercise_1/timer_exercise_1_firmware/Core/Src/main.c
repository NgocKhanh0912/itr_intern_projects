...
/* Private variables ---------------------------------------------------------*/
bsp_gpio_t LED[NUMBER_OF_LEDS] = {
    {GPIOD, GPIO_PIN_13, 0, GPIO_MODE_OUTPUT_PP},
    {GPIOD, GPIO_PIN_14, 0, GPIO_MODE_OUTPUT_PP},
    {GPIOD, GPIO_PIN_15, 0, GPIO_MODE_OUTPUT_PP},
};

bsp_gpio_t BUTTON = {GPIOA, GPIO_PIN_0, 0, GPIO_MODE_INPUT};
